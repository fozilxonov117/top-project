  ...
  return (
    <div className={cn('bg-[#ffffff08] backdrop-blur-md rounded-xl border border-white/10 overflow-hidden', className)}>
      ...
      <div className="bg-[#ffffff12] border-b border-white/10">
        <div className="grid grid-cols-6 gap-4 px-6 py-4 text-sm font-semibold text-gray-300">
          <button
            onClick={() => handleSort('rank')}
            className="text-left hover:text-white transition-colors flex items-center gap-1"
          >
            {t('rank')}
            <span className="text-xs">{getSortIcon('rank')}</span>
          </button>
          <button
          ...
          <button
            ...
            className="text-center hover:text-white transition-colors flex items-center justify-center gap-1"
          >
            {t('count')}
